...
pr1iv21et2Button = KeyboardButton('Редактировать заявку ✍️')
...
async def send(message):
    ...
    if steps[message.from_user.id] == 0:
        ...
        mainButton.add(pr2iv21et2Button, pri3v2et2Button, pr1iv21et2Button)
        ...
        if message.text == 'Редактировать заявку ✍️':
            steps = 0
